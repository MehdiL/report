...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.capoupascap";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "capoupascap";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.capoupascap.sync";
    ...
    public static final class Http {
        ...
        public static final String PARSE_APP_ID = "2xNBTa43OrUC8peMhjvzvN4xlpwbIgN6jewP0aEp";
        public static final String PARSE_REST_API_KEY = "u402MEKMSwkUzyDMnhYgVaEyB9riKwc0HCfmYyPw";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.capoupascap.";
